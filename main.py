...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--n_clfs', default=6, type=int)
    ...
    ##### 1. ------ GET DATASET
    X, y, ft_names = ut.read_dataset("D:/PycharmProjects/software_defect_prediction-master/datasets/",
    ...
    print("用时：", time.time() - startTime, "秒")  # 计时结束
    pl.legend(loc="best")
    pl.show()
